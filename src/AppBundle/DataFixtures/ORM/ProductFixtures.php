    ...
    public function load(ObjectManager $manager) :void
    {
        $apples = [
            [
                ...
                'countries' => [
                    ['country' => $this->getReference('country-DE'), 'price' => 100, 'min' => 1, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-DE'), 'price' => 75,  'min' => 3, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-DE'), 'price' => 50,  'min' => 6, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-DE'), 'price' => 10,  'min' => 12, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-AT'), 'price' => 100, 'min' => 1, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-AT'), 'price' => 75,  'min' => 3, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-AT'), 'price' => 50,  'min' => 6, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-AT'), 'price' => 10,  'min' => 12, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-CH'), 'price' => 75,  'min' => 6, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                    ['country' => $this->getReference('country-CH'), 'price' => 50,  'min' => 12, 'from' => '2020-01-01 00:00:00', 'until' => '2025-12-31 23:59:59'],
                ],
                "stock_up" => [
